...
class RegistrationManager {
                ...
                <div class="p-8 flex flex-col items-center text-center gap-8">
                    ...
                    <div class="space-y-6 w-full">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="bg-slate-50 dark:bg-slate-700/50 p-4 rounded-2xl border border-slate-100 dark:border-slate-700 col-span-2">
                                <p class="text-[9px] font-black uppercase tracking-widest text-slate-400 mb-1">Email (for Alerts)</p>
                                <p class="font-bold text-slate-800 dark:text-white text-sm truncate">${student.email || 'N/A'}</p>
                            </div>
                        </div>
    ...
    async registerStudent() {
        ...
        if (!fullName || !studentId || !course || !email) {
    ...
    resetPage() {
        ...
        // Clear inputs
        ['regFullName', 'regStudentId', 'regEmail', 'regCourse', 'regYearLevel'].forEach(id => {
